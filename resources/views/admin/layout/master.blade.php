      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
		      	...
		      	<li><a href="/adminpanel/category/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد دسته بندی جدید</a></li>
            <li><a href="/adminpanel/category/"><i class="mdi mdi-toggle-switch-off"></i>لیست دسته بندی ها</a></li>
